...
\begin{theorem}[1-dimensional Itô's Formula]
    ...
    \begin{equation*}
        Y_t = Y_0+\int_0^t\frac{\partial g}{\partial x}(s,X_s)v_s\d{B_s}+\int_0^t\left(\frac{\partial g}{\partial t}(s,X_s)+\frac{\partial^2 g}{\partial x^2}(s,X_s)u_s^2\frac{\partial g}{\partial x}(s,X_s)v_s^2\right)\d{s}.
    \end{equation*}
\end{theorem}
\begin{proof}
    Later ...
...
\begin{proof}
    ...
    \begin{enumerate}[nl]
        \item Show that the limit of $T_t^\Delta(M)$ exists as mesh $\Delta$ goes to 0.
            ...
            This also implies that $M_t^2-M_t^\Delta(M)$ is a continuous martingale.
    \end{enumerate}
\end{proof}
\end{document}
