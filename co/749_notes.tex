...
\end{theorem}
\begin{proof}
    % Set $G=G_1$, and $D_1$ a finite cut in $G$.
    % Then $G_2=G_1-D_1$, and repeat countably many times.
    % Do this by Zorn's lemma.
    % We must show that some component has uncountable chromatic number.
