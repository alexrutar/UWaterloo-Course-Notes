...
\begin{remark}
    \begin{enumerate}[nl,r]
        \item Faces of $C$ are themselves convex subsets.
        \item A face $F'$ of a face $F$ of $C$ is itself a face of $C$.
...
\begin{proof}
    ...
    We let $\mathcal{F}=\{F:F\text{ is a $w^*-$closed face of $C$}\}$, which is partially ordered by reverse inclusion.
